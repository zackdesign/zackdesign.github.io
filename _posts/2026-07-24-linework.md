...
I've been building a "will this part actually fit your bike?" planner — the sort of tool that tells you whether a given rear shock, dropper, or ebike motor bolts onto *your* frame before you spend the money. It grew out of my earlier [bike-part-planner](/bike-part-planner/) engine, and the thing that makes it click is the drawing: an exploded, service-manual-style diagram of the bike with every part ballooned to a parts list, that you can grab and rotate to see how the pieces sit in space.
