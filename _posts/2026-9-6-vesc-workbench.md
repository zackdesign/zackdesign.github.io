...
And it has been ridden. Speed, current, charge and range on the glass, both controllers read, at 40 km/h on grass — which is the only test that was ever going to settle it, and the one the whole harness exists to earn the right to run.
